...
ActiveRecord::Schema[7.1].define(version: 2026_09_21_000001) do
  ...
  create_table "badge_impressions", force: :cascade do |t|
    ...
    t.index ["user_id", "kind", "viewed_at"], name: "index_badge_impressions_on_user_id_and_kind_and_viewed_at"
    t.index ["user_id"], name: "index_badge_impressions_on_user_id"
  end
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.index ["name", "day"], name: "index_events_on_name_and_day"
    t.index ["user_id", "name", "detail", "day"], name: "index_events_once_per_user_per_day", unique: true
  ...
  create_table "sync_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "source", "ran_at"], name: "index_sync_logs_on_user_source_ran_at"
  ...
  add_foreign_key "badge_impressions", "users"
